...
ex) https://github.com/godrm/swift-chessgame
```

3. clone한 프로젝트 이동
```
cd {저장소 아이디}
ex) cd swift-chessgame
```
...
ex) git push --set-upstream origin chess-step1
```
...
10. 기본(upstream) 브랜치 전환 및 base 저장소 추가하기(최초 시작하기 단계 한번만 하면 됨)
	...
	ex) git remote add upstream https://github.com/code-squad/swift-chessgame.git
	```
